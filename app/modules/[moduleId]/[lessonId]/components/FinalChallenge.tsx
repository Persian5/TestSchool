...
export const FinalChallenge = ({ targetWords, points, onComplete }: FinalChallengeProps) => {
  // Define the phrases for the conversation
    ...
    <div className="w-full py-2">
      ...
      <AnimatePresence>
        {showFeedback && (
          ...
          >
            {isCorrect 
              ? "🎉 Perfect! You've mastered the greeting sequence!" 
              : "⚠️ Not quite right. The order should be: Hello, Welcome, How are you?, Goodbye."}
          </motion.div>
        )}
      </AnimatePresence>
    </div>
